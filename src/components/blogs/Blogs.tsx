            ...
            {blogs.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-8">
                    {blogs.map((post) => (
                        ...
                        >
                            <Link href={`/blogs/${post.slug}`} className="absolute inset-0 z-10" aria-label={`Read more about ${post.title}`}>
                            ...
                            <div className="relative h-56 w-full overflow-hidden rounded-t-2xl">
                                ...
                                />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div> {/* Subtle dark overlay */}
                            ...
                            <div className="p-6 flex flex-col flex-grow relative z-20"> {/* `flex-grow` ensures consistent footer alignment */}
                                ...
                                <div className="flex items-center justify-between mt-auto pt-5 border-t border-gray-100">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-0.5">{getTimeAgo(post.publishedAt)}</p>
                                        </div>
                                    </div>
                ...
                <div className="text-center py-20 bg-gray-50 rounded-xl shadow-lg border border-gray-200">
                    <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-8 text-gray-500 animate-pulse-slow">
                        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.467-.881-6.077-2.33" />
                        </svg>
                    </div>
                    <h3 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-4 tracking-tight">No Articles Yet!</h3>
                    <p className="text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed text-base md:text-lg">
                        It looks like our blog is still blooming. Check back soon for fresh insights and engaging stories!
                    </p>
                    <Link
                        href="/"
