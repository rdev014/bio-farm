      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center space-x-2">
            <span
              className="text-2xl font-bold bg-gradient-to-r from-green-600 to-green-400 
          ...
          <div className="hidden sm:flex items-center space-x-8">
            {["About", "Products", "FAQ", "Contact"].map((item) => (
              ...
              >
                {item}
                <span
                  className="absolute inset-x-0 bottom-0 h-0.5 bg-green-500 scale-x-0 
...
<p className="text-black">{user?.email? user.email: "Email not Found"}</p>
          {/* Right Side Actions */}
         ...
         <form
            ...
            >
              <div className="w-6 h-6 flex items-center justify-center relative">
                {/* <span
                  className={`transform transition-all duration-300 flex w-5 h-0.5 bg-gray-600 absolute ${
