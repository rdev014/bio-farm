          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex items-center justify-center text-white space-x-4">
              <div className="flex items-center">
                <div className="h-10 w-10 rounded-full bg-gradient-to-r from-green-600/10 to-green-400/10 flex items-center justify-center ring-2 ring-green-500/20">
          ...
          <article className="lg:col-span-8">
            <div className="bg-white rounded-2xl shadow-sm p-6 md:p-10">
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <h3 className="text-sm font-medium text-gray-500 mb-3">Tagged with</h3>
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <div className="flex items-center">
                  <div className="h-12 w-12 rounded-full bg-gradient-to-r from-green-600/10 to-green-400/10 flex items-center justify-center ring-2 ring-green-500/20">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-500">Expert in Sustainable Agriculture</p>
                  </div>
                </div>
              </div>
            </div>
